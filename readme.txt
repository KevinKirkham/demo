...
Each Shape has an Animation object, which handles all things associated with the sprites in the shape's animation, and a Path object which does the math for calculating and maintaining the Shape's current position.
